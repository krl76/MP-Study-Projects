...
{
    private static readonly List<PlayerSpawnPoint> s_SpawnPoints = new List<PlayerSpawnPoint>();
    ...
    public static PlayerSpawnPoint GetByIndex(int index)
    {
        CleanupNulls();
    ...
    private static int ComparePoints(PlayerSpawnPoint left, PlayerSpawnPoint right)
    {
    ...
    {
        Gizmos.color = new Color(0.25f, 0.8f, 0.95f, 0.9f);
